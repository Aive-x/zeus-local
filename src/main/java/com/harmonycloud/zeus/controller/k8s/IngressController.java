 ...
 * @date 2021/03/23
 */
@Api(tags = "ingress", value = "中间件对外访问")
@RestController
...
public class IngressController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "clusterId", value = "集群id", paramType = "path", dataTypeClass = String.class),
            @ApiImplicitParam(name = "namespace", value = "命名空间", paramType = "path", dataTypeClass = String.class),
            @ApiImplicitParam(name = "middlewareName", value = "中间件名称", paramType = "path", dataTypeClass = String
            .class),
            @ApiImplicitParam(name = "type", value = "中间件类型", paramType = "query", dataTypeClass = String.class)
    ...
    public BaseResult<IngressDTO> get(@PathVariable("clusterId") String clusterId, @PathVariable("namespace") String
    namespace,
                                      @PathVariable("middlewareName") String middlewareName,
                                      @RequestParam("type") String type,
                                      @PathVariable("name") String name,
        ...
        return BaseResult.ok(ingressService.get(clusterId, namespace, type, middlewareName, name, exposeType,
        protocol));
    }*/
