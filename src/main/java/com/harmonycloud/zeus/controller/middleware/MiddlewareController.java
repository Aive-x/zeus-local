 ...
 * @date 2021/03/23
 */
@Api(tags = "middleware", value = "分区下中间件", description = "分区下中间件")
@RestController
...
public class MiddlewareController {
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "clusterId", value = "集群id", paramType = "path", dataTypeClass = String.class),
        @ApiImplicitParam(name = "namespace", value = "命名空间", paramType = "path", dataTypeClass = String.class),
        @ApiImplicitParam(name = "middleware", value = "middleware信息", paramType = "query",
            dataTypeClass = Middleware.class)
    })
    @PostMapping
    ...
    @ApiImplicitParams({
        ...
        @ApiImplicitParam(name = "middlewareName", value = "中间件名称", paramType = "path", dataTypeClass = String.class),
        @ApiImplicitParam(name = "type", value = "中间件类型", paramType = "query", dataTypeClass = String.class),
        @ApiImplicitParam(name = "isAuto", value = "true开启/false关闭自动切换，不传/传null都为手动切换", paramType = "query",
