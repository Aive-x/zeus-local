 ...
 */
@Api(tags = "middlewareAlert", value = "中间件告警", description = "中间件告警")
@RestController
...
public class MiddlewareAlertsController {
    ...
    @ApiImplicitParams({
        ...
        @ApiImplicitParam(name = "namespace", value = "命名空间", paramType = "path", dataTypeClass = String.class),
        @ApiImplicitParam(name = "middlewareName", value = "中间件名称", paramType = "path", dataTypeClass = String.class),
        @ApiImplicitParam(name = "middlewareAlertsDTO", value = "中间件告警规则", paramType = "query",
            dataTypeClass = MiddlewareAlertsDTO.class)
    })
    @PostMapping
