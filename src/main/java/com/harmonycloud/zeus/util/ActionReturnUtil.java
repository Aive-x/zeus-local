...
public class ActionReturnUtil extends HashMap<String, Object> {
    ...
    public static ActionReturnUtil returnError(ErrorCodeMessage error, String extendMessage,
    ...
    public static ActionReturnUtil returnError(String extendMessage, ErrorCodeMessage error,
        String errorDetailMessage) {
        return returnError(error, extendMessage, errorDetailMessage, true);
    }

    private static ActionReturnUtil returnError(ErrorCodeMessage error, String extendMessage, String errorDetailMessage,
        boolean prefix) {
        ActionReturnUtil returnMap = new ActionReturnUtil();
        returnMap.put("success", false);
        returnMap.put("errorCode", error.value());
    ...
    public static ActionReturnUtil returnErrorWithMsg(ErrorCodeMessage error, String extendMessage, boolean prefix)
        throws CaasRuntimeException {
